...
Batch_Corrected_Counts <- function(Normalized_Counts, ccbr991_metadata_nidap) {
...
var_Batch_Corrected_Counts<-Batch_Corrected_Counts(var_Normalized_Counts,var_ccbr991_metadata_nidap)
invisible(graphics.off())
