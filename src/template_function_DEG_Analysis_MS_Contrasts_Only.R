...
DEG_Analysis_MS_Contrasts_Only <- function(Filtered_Counts, ccbr991_metadata_nidap) {
    ...
    contrasts<-c("IL7R-Control","NRAS-Control","Both-Control")
...
print("template_function_DEG_Analysis_MS_Contrasts_Only.R #########################################################################")
...
var_DEG_Analysis_MS_Contrasts_Only<-DEG_Analysis_MS_Contrasts_Only(var_Filtered_Counts,var_ccbr991_metadata_nidap)
invisible(graphics.off())
saveRDS(var_DEG_Analysis_MS_Contrasts_Only, paste0(rds_output,"/var_DEG_Analysis_MS_Contrasts_Only.rds"))
