...
GSEA_Selected <- function(DEG_Analysis, GSEA_Preranked, Batch_Corrected_Counts, ccbr991_metadata_nidap, msigdb_v6_2_with_orthologs) {
...
## PARAMETERS
    ...
    plot_limit = "ALL"
    topline = 'coordinate'
    pathways = c("HALLMARK_MYC_TARGETS_V1","HALLMARK_G2M_CHECKPOINT","HALLMARK_E2F_TARGETS","HALLMARK_APOPTOSIS")
    geneid = "Gene"
    geneid_gex = "Gene"
    contrasts = c()
    species = "Mouse"
...
png(filename="GSEA_Selected.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_GSEA_Selected.R #########################################################################")
...
var_GSEA_Selected<-GSEA_Selected(var_DEG_Analysis,var_GSEA_Preranked,var_Batch_Corrected_Counts,var_ccbr991_metadata_nidap,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Selected, paste0(rds_output,"/var_GSEA_Selected.rds"))
